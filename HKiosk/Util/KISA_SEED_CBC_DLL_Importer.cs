...
namespace HKiosk.Util
{
    public static class KISA_SEED_CBC_DLL_Importer
    {
        ...
        [DllImport("KISA_SEED_CBC_DLL.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SEED_CBC_Encrypt")]
        ...
        [DllImport("KISA_SEED_CBC_DLL.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SEED_CBC_Decrypt")]
        ...
        [DllImport("KISA_SEED_CBC_DLL.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SEED_CBC_Encrypt_String")]
        ...
        [DllImport("KISA_SEED_CBC_DLL.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SEED_CBC_Decrypt_String")]
